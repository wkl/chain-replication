...
bool send_msg_tcp(proto::Address, const proto::Message_MessageType,
                  const pb::Message &);
bool send_msg_udp(proto::Address, proto::Address,
                  const proto::Message_MessageType, const pb::Message &);
bool msg_udp_loop(proto::Address, proto::Address,
                  const proto::Message_MessageType, const pb::Message &,
                  proto::Message &);
